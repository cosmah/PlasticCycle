...
export default function PickupDetails() {
  ...
  const breadcrumbs = [
    ...
    },
    {
      ...
      href: route('business.pickup-details', { id: pickupRequest?.id }),
    },
  ];
          ...
          <Card className="mt-6">
            <CardContent className="p-8 text-center">
              ...
              <Button variant="outline" className="mt-4" asChild>
                <Link href="/business/requests">Back to Requests</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3 mt-2 sm:mt-0">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/business/requests">Back</Link>
            </Button>
          </div>
        </div>
          ...
          <Card className="bg-white shadow-sm md:col-span-2">
            ...
            <CardContent className="pt-4">
              <p className="text-gray-600">
                {pickupRequest.compliance_notes || 'No compliance notes provided.'}
              </p>
            </CardContent>
          </Card>
        </div>
